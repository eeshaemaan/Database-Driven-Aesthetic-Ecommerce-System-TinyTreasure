...
{
    public partial class PlushPage : Form
    {
        public PlushPage()
        {
            InitializeComponent();
        ...
        {
            Detail detailPage = HelperFunctions.GetProductDetailPage("Pooh Plushie", "poohPlushie");
            detailPage.ShowDialog();
        }
        // capybara plush click
        private void button4_click(object sender, EventArgs e)
        {
            Detail detailPage = HelperFunctions.GetProductDetailPage("Capybara Plushie", "capybaraPlushie");
            detailPage.ShowDialog();
        }
        // mood plush click
        private void button3_click(object sender, EventArgs e)
        {
            Detail detailPage = HelperFunctions.GetProductDetailPage("Mood Plush", "moodPlush");
            detailPage.ShowDialog();
        }
        // stitch plush click
        ...
        {
            Detail detailPage = HelperFunctions.GetProductDetailPage("Cat Plushie", "catPlushie");
            detailPage.ShowDialog();
        }
        // Alien plush click
        private void button5_Click(object sender, EventArgs e)
        {
            Detail detailPage = HelperFunctions.GetProductDetailPage("Alien Plushie", "alienPlushie");
            detailPage.ShowDialog();
        }
