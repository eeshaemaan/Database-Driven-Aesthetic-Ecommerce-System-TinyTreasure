...
* **Language:** C#
* **Framework:** WinForms
* **Database:** MySQL (Remote via Aiven)
* **IDE:** Visual Studio
...
* Followed agile-style **sprint planning**
* Peer collaboration and task distribution:
    1. Ayesha Amer:
    Sprint 1: Major Role: C# UI implementation (creat- ing the UI based on the prototypes)
    Sprint 2: Implementation of Cart Page and Navigation Bar, Class Diagram and Activity Diagram
    Sprint 3:	Implementation of Login/Register Page,
    Boundary value analysis testing of Login Page
    
    2. Eesha Emaan:
    Sprint 1: Major Role: Documentation, Minor Role: C# UI implementation of 1 page
    Sprint 2: Implementation of Search Feature, Use Case Diagram and Sequence Diagram
    Sprint 3: Functionality of Checkout Page information storage, Burndown Chart, presentation slides, Boundary
    value analysis testing of Register Page
...
3. Update the MySQL connection string (if needed)
