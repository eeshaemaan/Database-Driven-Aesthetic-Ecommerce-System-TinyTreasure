...
{
    public partial class StationeryPage : Form
    {
        public StationeryPage()
        {
            InitializeComponent();
        ...
        // pastel Diaries click
        private void button2_click(object sender, EventArgs e)
        {
            Detail detailPage = HelperFunctions.GetProductDetailPage("Pastel Diaries", "pastelDiaries");
            detailPage.ShowDialog();
        }
        // mushroom pouch click
        private void button3_click(object sender, EventArgs e)
        {
            Detail detailPage = HelperFunctions.GetProductDetailPage("Mushroom Pouch", "mushroomPouch");
            detailPage.ShowDialog();
        }
        // bubble teddy pens
        private void button4_click(object sender, EventArgs e)
        {
            Detail detailPage = HelperFunctions.GetProductDetailPage("Bubble Teddy Pens", "bubbleTeddyPens");
            detailPage.ShowDialog();
        }
        // smooth gelpens click
        private void button1_click(object sender, EventArgs e)
        {
            Detail detailPage = HelperFunctions.GetProductDetailPage("Smooth Gel Pens", "smoothGelPensSet");
            detailPage.ShowDialog();
        }
        // watercolor pens click
        private void button6_click(object sender, EventArgs e)
        {
            Detail detailPage = HelperFunctions.GetProductDetailPage("WaterColor Pens", "WaterColorPens");
            detailPage.ShowDialog();
        }
        // blue stationary holder
        private void button5_click(object sender, EventArgs e)
        {
            Detail detailPage = HelperFunctions.GetProductDetailPage("Blue Stationary Holder", "BlueStationaryHolder");
            detailPage.ShowDialog();
        }
